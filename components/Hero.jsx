...
const Hero = () => {
  return (
    ...
    >
      ...
      <p className="transform scale-y-150 absolute 2xl:top-173 lg:top-110 md:top-220 top-133 inset-x-0 flex items-center justify-center z-50 bg-gradient-to-r from-[#707070] via-[#FFFFFF] to-[#707070] bg-clip-text text-transparent 2xl:text-5xl lg:text-4xl md:text-4xl text-[23px] font-semibold uppercase">
        Xalqaro biznes ta&apos;lim loyihasi
      </p>

      <Button variant="custom" size="custom" className="absolute z-50 2xl:top-195 lg:top-125 md:top-240 top-148 left-1/2 -translate-x-1/2">
