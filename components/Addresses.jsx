  ...
  return (
    <div className="p-16 bg-black 2xl:px-44">
      ...
      <div className="flex justify-between items-start gap-10">
        <div className="w-1/3 flex flex-col items-center text-center bg-[#373737] rounded-lg border border-[#666666] h-auto">
          <Image
            src={"/hyatt.png"}
            alt=""
            width={1000}
        ...
        <div className="w-1/3 flex flex-col items-center text-center space-y-6 bg-[#373737] rounded-lg border border-[#666666]">
          <Image
            src={"/london.png"}
            alt=""
            width={1000}
